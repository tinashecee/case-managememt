...
class InvoiceGenerator {
    ...
    generateHeaders(doc) {
        ...
        doc.text(`Contracts Report | ${this.invoice.status} :  From ${moment(this.invoice.start_date).format('Do MMMM, YYYY')} to ${moment(this.invoice.end_date).format('Do MMMM, YYYY')}`, 5, 210,{bold: true})
