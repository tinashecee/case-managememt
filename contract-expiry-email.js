...
const SENDCONTRACTEXPIRY = async (
  email,
  contract_name,
  period,
  name,
  ...
  const options = {
    ...
    subject: `A contract is about to expire in a ${period} month!`, // Subject line
    text: message,
    html: `
                                          ...
                                          <table width="310" border="0" cellpadding="0" cellspacing="0" align="right" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="fullCenter">
                                              ...
                                              <tr>
                                                  <td valign="middle" width="100%" style="text-align: left; font-family: Helvetica, Arial, sans-serif, 'Open Sans'; font-size: 14px; color: #828282; line-height: 22px; font-weight: 400;" class="fullCenter">
                                                      <span style="color: rgb(0, 0, 0);" >Dear ${name},</span></p><p><br><span style="color: rgb(0, 0, 0);" > <p>This is a reminder that the contract for ${vendor} is about to expire on ${end_date}.</p>
                                                      <p>Please review the contract details below:</p>
                                                      <ul>
                                                      <li>Contract Name: ${contract_name}</li>
                                                      <li>Contract Description: ${notes}</li>
                                                      <li>Contract Value: $ ${contract_value}</li>
                                                      <li>Expiry Date: ${end_date}</li>
                                                      </ul></span>
                                                      <br><span style="color: rgb(0, 0, 0);" >Regards,&nbsp;</span></p><p><br><span style="color: rgb(0, 0, 0);" >Legal Department</span>
                                                  </td>
                                              </tr>
                                              <tr>
...
module.exports = SENDCONTRACTEXPIRY;
